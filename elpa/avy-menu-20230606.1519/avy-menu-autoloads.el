;;; avy-menu-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(register-definition-prefixes "avy-menu" '("avy-menu--insert-strings"))

;;;***

;;;### (autoloads nil nil ("avy-menu-pkg.el") (0 0 0 0))
